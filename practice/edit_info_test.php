              ...
              <table id="info">
                ...
                <tr>
                  ...
                  <td><input name="name" value="<?php print $name; ?>" /><br>
                      <div class="error_message"><?php print $messages['login']; ?></div></td>
                </tr>
	    
                <tr>
                  <td>Gender:</td>
                  <td><input type="radio" name="gender" value="Male" <?php if ($gender == "Male"){ print "checked='checked'"; } ?> />Male<br>
                      <input type="radio" name="gender" value="Female" <?php if ($gender == "Female"){ print "checked='checked'"; } ?> />Female<br></td>
                </tr>
